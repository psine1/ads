...
var multitimeline = new TimelineMax({paused:false, repeat: 0});
    multitimeline
    .add(divider('#bg-1', '#bg-1 img', -728, 900, 0, 0, 'null'), 0)
    .add(fr1(), 0)
    .set('#color-1, #color-2, #color-3, #color-4', {left: "0px"}, 2.8)
    .add(divider('#bg-2', '#bg-2 img', 0, 0, -150, 150, '#bg-1'), 2.8)
    .add(fr2(), 3.1)
    .add(divider('#bg-3', '#bg-3 img', 728, -728, 0, 0, '#bg-2'), 5.8)
    .add(fr3(), 6.1)
    .add(divider('#bg-4', '#bg-4 img', 0, 0, 150, -150, '#bg-3'), 8.8)
    .add(fr4(), 9.1)
...
function fr2(){ 
    ...
    tl_
          ...
          .to('[id*="txt-1-"]', 0.5, {autoAlpha: 0, ease:Power3.easeOut}, 0 )
...
function fr4(){ 
        ...
        tl_
              ...
              /*
              .from('#ball', 1.3, {y: -500, ease:Elastic.easeOut.config(0.6, 0.3)}, 2)
              .from('#triangle', 1.3, {y: -500, rotation: 80, ease:Elastic.easeOut.config(0.6, 0.3)}, 2.1)
      
              .to('#ball img', 0.3, {y: -40, ease:Power1.easeOut}, 0)
              .to('#triangle img', 0.3, {y: -40, ease:Power1.easeOut}, 0.1)    
              
              .to('#ball img', 0.3, {y: 0, ease:Power1.easeOut}, 1.5)
              .to('#triangle img', 0.3, {y: 0, ease:Power1.easeOut}, 1.5)  

              */

              .from('#ball', 0.3, {y: -350, ease:Power1.easeIn}, 2)
              .from('#triangle', 0.3, {y: -350, ease:Power1.easeIn}, 2.1) 
              
              .to('#ball', 0.3, {y: -150, x: -20, rotation: -30, ease:Power1.easeOut}, 2.3)
              .to('#triangle', 0.3, {y: -150, x: 20, rotation: 30, ease:Power1.easeOut}, 2.4) 
