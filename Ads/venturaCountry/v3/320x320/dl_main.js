...
function fr1(){ 
        ...
        .to('.anim-heart-1, .anim-heart-2, .anim-heart-3', 0.8, { repeat: -1, x: -1260, ease: SteppedEase.config(3)}, 0)
...
function fr2(){ 
    ...
    tl_
          ...
          .to('.anim-bottle-1, .anim-bottle-2, .anim-bottle-3', 0.8, { repeat: -1, x: -1260, ease: SteppedEase.config(3)}, 0)
...
function fr3(){ 
    ...
    //      .to("#turb-3wave", 0.4, {   attr: { "baseFrequency": 0.03 }, repeat: -1, yoyo: true, ease:Linear.easeNone}, 0)
      ...
      //    .to("#turb-3-b-wave", 0.4, {   attr: { "baseFrequency": 0.03 }, repeat: -1, yoyo: true, ease:Linear.easeNone}, 0)
          ...
          .to('.wrap-man, .wrap-man2, .wrap-man3', 0.8, { repeat: -1, x: -960, ease: SteppedEase.config(3)}, 0)
