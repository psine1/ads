...
var multitimeline = new TimelineMax({paused:false, repeat: 0});
    multitimeline
    .add(divider('#bg-1', 20, 0, 'null', 0.5, -0.3), 0)
    .add(fr1(), 0)
    .set('#color-1, #color-2, #color-3, #color-4', {left: "0px"}, 2.8)
    .add(divider('#bg-2, #anim-bottle',  20, 0, '#bg-1, #anim-heart', -0.5, 0.3), 2.8)
    .add(fr2(), 3.1)
    .add(divider('#bg-3, #anim-man', 0, -10, '#bg-2, #anim-bottle', 0.5, -0.3), 5.8)
    .add(fr3(), 6.1)
...
function fr4(){ 
    ...
    tl_
          ...
          .to('#anim-btn-1, #anim-btn-2, #anim-btn-3', 0.8, { repeat: -1, x: -261, ease: SteppedEase.config(3)}, 0)
          .to("#turb-flower-wave", 0.3, {   attr: { "baseFrequency": 0.03 }, repeat: -1, yoyo: true, ease:Linear.easeNone}, 0)

          
          .set('.wrap-flower-sel', {rotation: -10, x: -55, y: -15, scale: 0.3}, 0)

          .set('#wrap-btn img', {scale: 0.95}, 0)
