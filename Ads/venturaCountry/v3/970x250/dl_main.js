...
var multitimeline = new TimelineMax({paused:false, repeat: 0});
    multitimeline
    .add(divider('#bg-1, #anim-heart', 50, 0, 'null', 2, -1), 0)
    .add(fr1(), 0)
    .set('#color-1, #color-2, #color-3, #color-4', {left: "0px"}, 2.8)
    .add(divider('#bg-2, #anim-bottle',  50, 0, '#bg-1, #anim-heart', -2, 1), 2.8)
    .add(fr2(), 3.1)
    .add(divider('#bg-3, #anim-man', 0, -50, '#bg-2, #anim-bottle', 2, -1), 5.8)
    .add(fr3(), 6.1)
...
function fr1(){ 
       ...
       // .set('#txt-1-a, #txt-1-b', {filter: colorShadow}, 0)

       /*
       .add(function(){ 
        txt1a.classList.add("shadow1");
        txt1b.classList.add("shadow1");
       }, 0)


       */
       .to('.anim-heart-1, .anim-heart-2, .anim-heart-3', 0.8, { repeat: -1, x: -3210, ease: SteppedEase.config(3)}, 0)
...
function fr2(){ 
    ...
    tl_
      ...
      //    .to('[id*="txt-1-a"]', 0.5, {x: 20, ease:Power3.easeOut}, 0 )

      //    .set('#txt-1-a, [id*="txt-2-"]', {filter: colorShadow}, 0)
/*
      .add(function(){ 
...
*/
          ...
          .to('.anim-bottle-1, .anim-bottle-2, .anim-bottle-3', 0.8, { repeat: -1, x: -3210, ease: SteppedEase.config(3)}, 0)
...
function fr3(){ 
    ...
    tl_
          ...
          .to('[id*="txt-1-a"]', 0.5, {x: -3, ease:Power3.easeOut}, 0 )
          /*
          .add(function(){ 
    ...
    //      .set('#txt-1-a, [id*="txt-3-"]', {filter: colorShadow}, 0)
    ...
    //      .to("#turb-3wave", 0.4, {   attr: { "baseFrequency": 0.03 }, repeat: -1, yoyo: true, ease:Linear.easeNone}, 0)
      ...
      //    .to("#turb-3-b-wave", 0.4, {   attr: { "baseFrequency": 0.03 }, repeat: -1, yoyo: true, ease:Linear.easeNone}, 0)
          ...
          .to('.wrap-man, .wrap-man2, .wrap-man3', 0.8, { repeat: -1, x: -2910, ease: SteppedEase.config(3)}, 0)
...
function fr4(){ 
    ...
    tl_
          ...
          .to('#anim-btn-1, #anim-btn-2, #anim-btn-3', 0.8, { repeat: -1, x: -579, ease: SteppedEase.config(3)}, 0)
          .to("#turb-flower-wave", 0.3, {   attr: { "baseFrequency": 0.03 }, repeat: -1, yoyo: true, ease:Linear.easeNone}, 0)

          
          .set('.wrap-flower-sel', {rotation: -10, x: -10, scale: 1.2}, 0)
...
tl_
      ...
      .fromTo(elem, 1, {rotation: rotateIn, scale: 1.2}, {rotation: 0, scale: 1, ease:Power3.easeInOut}, 0)  
    ...
    //  .fromTo(elemImg, 1, {scale: 1, rotation: 5}, {scale: 1.08, rotation: 0, ease:Power3.easeOut}, "-=0.2")  
      ...
      .fromTo(elemOut, 0.5, {rotation: 0, scale: 1}, {rotation: rotateOut, scale: 1.02, ease:Power3.easeInOut}, 0)  
