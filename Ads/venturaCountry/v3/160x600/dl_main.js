...
var multitimeline = new TimelineMax({paused:false, repeat: 0});
    ...
    .add(fr2(), 3.1)
    .add(divider('#bg-3, #anim-man', 50, 0, '#bg-2, #anim-bottle', 2, -5), 5.8)
    .add(fr3(), 6.1)
...
function fr1(){ 
        ...
        .to('.anim-heart-1, .anim-heart-2, .anim-heart-3', 0.8, { repeat: -1, x: -780, ease: SteppedEase.config(3)}, 0)
...
function fr2(){ 
    ...
    tl_
          ...
          .to('.anim-bottle-1, .anim-bottle-2, .anim-bottle-3', 0.8, { repeat: -1, x: -780, ease: SteppedEase.config(3)}, 0)
...
function fr3(){ 
    ...
    tl_
          ...
          .fromTo("#anim-man", 0.01, {clip:"rect(0px 0px 507px 0px)"}, {clip:"rect(0px 527px 507px 0px)", ease:Power3.easeOut}, 0.5)


          .to('.wrap-man, .wrap-man2, .wrap-man3', 0.8, { repeat: -1, x: -780, ease: SteppedEase.config(3)}, 0)
...
function fr4(){ 
    ...
    tl_
          ...
          .to('#anim-btn-1, #anim-btn-2, #anim-btn-3', 0.8, { repeat: -1, x: -369, ease: SteppedEase.config(3)}, 0)
          .to("#turb-flower-wave", 0.3, {   attr: { "baseFrequency": 0.03 }, repeat: -1, yoyo: true, ease:Linear.easeNone}, 0)



          .set('.wrap-flower-sel', {rotation: 15, x: 10}, 0)
