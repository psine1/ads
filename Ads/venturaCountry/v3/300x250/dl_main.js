...
var multitimeline = new TimelineMax({paused:false, repeat: 0});
    ...
    .add(divider('#bg-2, #anim-bottle',  20, 0, '#bg-1, #anim-heart', -5, 10), 2.8)
    .add(fr2(), 3.1)
...
function fr1(){ 
        ...
        .to('.anim-heart-1, .anim-heart-2, .anim-heart-3', 0.8, { repeat: -1, x: -1200, ease: SteppedEase.config(3)}, 0)
...
function fr3(){ 
    ...
    //      .to("#turb-3wave", 0.4, {   attr: { "baseFrequency": 0.03 }, repeat: -1, yoyo: true, ease:Linear.easeNone}, 0)
      ...
      //    .to("#turb-3-b-wave", 0.4, {   attr: { "baseFrequency": 0.03 }, repeat: -1, yoyo: true, ease:Linear.easeNone}, 0)
          .fromTo("#anim-man", 0.01, {clip:"rect(0px 0px 507px 0px)"}, {clip:"rect(0px 527px 507px 0px)", ease:Power3.easeOut}, 0.3)


          .to('.wrap-man, .wrap-man2, .wrap-man3', 0.8, { repeat: -1, x: -900, ease: SteppedEase.config(3)}, 0)
...
function fr4(){ 
    ...
    tl_
          ...
          .to('#anim-btn-1, #anim-btn-2, #anim-btn-3', 0.8, { repeat: -1, x: -264, ease: SteppedEase.config(2)}, 0)
