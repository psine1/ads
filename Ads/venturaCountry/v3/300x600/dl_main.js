...
var multitimeline = new TimelineMax({paused:false, repeat: 0});
    multitimeline
    .add(divider('#bg-1, #anim-heart', 50, 0, 'null', 5, -5), 0)
    .add(fr1(), 0)
    .set('#color-1, #color-2, #color-3, #color-4', {left: "0px"}, 2.8)
    .add(divider('#bg-2, #anim-bottle',  50, 0, '#bg-1, #anim-heart', -5, 10), 2.8)
    .add(fr2(), 3.1)
    .add(divider('#bg-3, #anim-man', 0, -50, '#bg-2, #anim-bottle', 5, -5), 5.8)
    .add(fr3(), 6.1)
...
function fr1(){ 
   ...
   //     .to("#turbwave", 0.4, {   attr: { "baseFrequency": 0.03 }, repeat: -1, yoyo: true, ease:Linear.easeNone}, 0)
   //     .from('[id*="anim-heart"]', 0.8, {rotation: 10, repeat: -1, yoyo: true, ease:Linear.easeNone}, 0)
   //     .fromTo("#anim-heart", 1.5, {clip:"rect(0px 0px 507px 0px)"}, {clip:"rect(0px 527px 507px 0px)", ease:Power3.easeOut}, 0.5)

        .to('.anim-heart-1, .anim-heart-2, .anim-heart-3', 0.8, { repeat: -1, x: -588, ease: SteppedEase.config(3)}, 0)
...
function fr2(){ 
    ...
    tl_
      ...
      //    .to("#turb-2wave", 0.4, {   attr: { "baseFrequency": 0.03 }, repeat: -1, yoyo: true, ease:Linear.easeNone}, 0)
          .fromTo("#anim-bottle", 1.5, {clip:"rect(0px 0px 507px 0px)"}, {clip:"rect(0px 527px 507px 0px)", ease:Power3.easeOut}, 0)

       .to('.anim-bottle-1, .anim-bottle-2, .anim-bottle-3', 0.8, { repeat: -1, x: -1200, ease: SteppedEase.config(3)}, 0)


          .to('[class*="light"]', 0.01, {top: 300}, 0)
...
function fr3(){ 
    ...
    //      .to("#turb-3wave", 0.4, {   attr: { "baseFrequency": 0.03 }, repeat: -1, yoyo: true, ease:Linear.easeNone}, 0)
      ...
      //    .to("#turb-3-b-wave", 0.4, {   attr: { "baseFrequency": 0.03 }, repeat: -1, yoyo: true, ease:Linear.easeNone}, 0)
          .fromTo("#anim-man", 0.01, {clip:"rect(0px 0px 113px 0px)"}, {clip:"rect(0px 285px 113px 0px)", ease:Power3.easeOut}, 0.3)

          .set("#anim-man",{scale: 1.75}, 0.3)

          .to('.wrap-man, .wrap-man2, .wrap-man3', 0.8, { repeat: -1, x: -855, ease: SteppedEase.config(3)}, 0)
...
function fr4(){ 
    ...
    tl_
          ...
          .to('#anim-btn-1, #anim-btn-2, #anim-btn-3', 0.8, { repeat: -1, x: -384, ease: SteppedEase.config(2)}, 0)
          .to("#turb-flower-wave", 0.3, {   attr: { "baseFrequency": 0.03 }, repeat: -1, yoyo: true, ease:Linear.easeNone}, 0)

          .set('.wrap-flower-sel', {rotation: -10, scale: 0.8, x: -20}, 0)
...
tl_
      ...
      .fromTo(elem, 1, {rotation: rotateIn, scale: 1.12}, {rotation: 0, scale: 1, ease:Power3.easeInOut}, 0)  
    ...
    //  .fromTo(elemImg, 1, {scale: 1, rotation: 5}, {scale: 1.08, rotation: 0, ease:Power3.easeOut}, "-=0.2")  
      ...
      .fromTo(elemOut, 0.5, {rotation: 0, scale: 1}, {rotation: rotateOut, scale: 1.12, ease:Power3.easeInOut}, 0)  
