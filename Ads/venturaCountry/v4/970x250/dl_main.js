...
var multitimeline = new TimelineMax({paused:false, repeat: 0});
    multitimeline
    .add(divider('#scene1', 0, 0, 'null', 0.5, -0.5), 0)
    .add(fr1(), 0)
    .set('#color-1, #color-2, #color-3, #color-4', {left: "0px"}, 2.8)
    .add(divider('#scene2',  -50, 0, 'null', -0.5, 0.5), 2.8)
    .add(fr2(), 3.1)
    .add(divider('#scene3', 0, -50, '#null', 0.5, 0.5), 5.8)
    .add(fr3(), 6.1)
...
function fr2(){ 
    ...
    tl_
          ...
          .fromTo('[id*="lantern"]', 1, {rotation: -2}, {rotation: 2, repeat: -1, yoyo: true, transformOrigin: '241px 98px', eease:Linear.easeNone}, 0 )
