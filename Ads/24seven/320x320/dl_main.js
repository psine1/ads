...
var imageArray = new Array("images/sflex.png", "images/logos.png", "images/btnPause.png", "images/btn_appStore.png", "images/btn_googlePlay.png");
...
function fr2(){
    var tl_fr2 = gsap.timeline();
    tl_fr2
        .to("[id*='fr1']", {duration: 1, autoAlpha: 0, ease: "power3.out"}, 0)
        .from("[id*='fr2']", {duration: 1, autoAlpha: 0, ease: "power3.out"}, 0.5)
        .to("[id*='logos']", {duration: 7, y: -700, ease: "none"}, 0)
        ;
    return tl_fr2  
    }  

function fr3(){
    var tl_fr3 = gsap.timeline();
    tl_fr3
        .to("[id*='fr2']", {duration: 1, autoAlpha: 0, ease: "power3.out"}, 0)
        .from("[id*='fr3']", {duration: 1, autoAlpha: 0, ease: "power3.out"}, 0.5)
        .from("[id*='smartphone']", {duration: 1.5, y: 300, ease: "power3.out"}, 0.5)
        .from("[id*='btnPause']", {duration: 0.01, autoAlpha: 0, ease: "power3.out"}, 2)
        .to("[id*='btnPlay']", {duration: 0.01, autoAlpha: 0, ease: "power3.out"}, 2) 
        .from("[id*='circleColor']", {duration: 0.5, autoAlpha: 0, repeat: 1, yoyo:true, ease: "power1.out"}, 2)        
        ;
    return tl_fr3  
    }  
...
function fr4(){
    ...
    tl_fr4
        .to("[id*='fr3']", {duration: 1, autoAlpha: 0, ease: "power3.out"}, 0)
        .from("[id*='fr4']", {duration: 1, autoAlpha: 0, ease: "power3.out"}, 0.5)
        .to("[id*='sflex'], [id*='btnPause']", {duration: 1.5, y: 300, ease: "power3.out"}, 0)

        .from("[id*='txt-2-a']", {duration: 1, autoAlpha: 0, y: 20, ease: "power3.out"}, 1.2)
        .from("[id*='txt-2-b']", {duration: 1, autoAlpha: 0, y: 20, ease: "power3.out"}, 1.4)
        .from("[id*='barLogo']", {duration: 1, autoAlpha: 0, y: 20, ease: "power3.out"}, 1.4)
        ...
        .to("[id*='barLogo']", {duration: 1, scaleY: 0.5, y: -77/2, transformOrigin: "0% 100%", ease: "power3.out"}, 2.5)
