...
.from("[id*='img-2-a']", 1.5, {y: 200,ease:Power2.easeInOut}, 0.4)
.from("[id*='img-2-b'], [id*='img-2-c']", 1.5, {y: 200, ease:Power2.easeInOut}, 0.6)
...
.to("[id*='img-2-b'], [id*='img-2-c']", 1.5, {y: 200, autoAlpha: 0, ease:Power2.easeInOut}, 0.2)
.to("[id*='img-2-a']", 1.5, {y: 200, autoAlpha: 0, ease:Power2.easeInOut}, 0.2)

.to("[id*='img-1-b']", 1.5, {y: 200, autoAlpha: 0, ease:Power2.easeInOut}, 0.4)
.to("[id*='img-1-a']", 1.5, {y: 200, autoAlpha: 0, ease:Power2.easeInOut}, 0.4)
...
.to("[id*='txt-0']", 1, {ease:Power2.easeOut, autoAlpha:0}, 0)
