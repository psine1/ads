...
.from("[id*='img-1-a']", 1.5, {y: 300,ease:Power2.easeInOut}, 0)
.from("[id*='img-1-b']", 1.5, {y: 300,ease:Power2.easeInOut}, 0)

.from("[id*='img-2-a']", 1.5, {y: 300,ease:Power2.easeInOut}, 0.4)
.from("[id*='img-2-b'], [id*='img-2-c']", 1.5, {y: 350, ease:Power2.easeInOut}, 0.6)
.to("[id*='img-2-c'] img", 2, {rotation: 360, repeat: -1, ease: Power0.easeNone}, 0)

// .staggerTo("[id*='img-']", 4, {x: 120, ease:Power2.easeOut}, 0.2, 0)
...
.to("[id*='img-1-a']", 1.5, {y: 300, ease:Power2.easeInOut}, 0.4)
