...
.from("[id*='img-1-c']", 1.5, {y: 400,ease:Power2.easeInOut}, 0.2)

.from("[id*='img-1-b']", 2, {autoAlpha: 0, ease:Power2.easeInOut}, 1)

.from("[id*='img-2']", 1.5, {y: 400,ease:Power2.easeInOut}, 0.4)

.from("[id*='img-3-a']", 1.5, {y: 400,ease:Power2.easeInOut}, 0.6)
.from("[id*='img-3-b']", 1.5, {y: 400,ease:Power2.easeInOut}, 0.6)

.fromTo("[id*='img-3-b'] img", 8, {x: 150}, {x: -200, ease:Linear.easeNone}, 2.3)

//.from("[id*='img-']", 2.5, {x: -122, ease:Power1.easeOut}, 0)
...
.from("[id*='logo']", 1, {ease:Power2.easeOut, autoAlpha:0}, 2.6)
