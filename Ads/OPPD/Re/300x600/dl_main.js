...
.from("[id*='img-1-a']", 1.5, {y: 350,ease:Power2.easeInOut}, 0)
.from("[id*='img-1-c']", 1.5, {y: 350,ease:Power2.easeInOut}, 0.2)

.from("[id*='img-1-b']", 2, {autoAlpha: 0, ease:Power2.easeInOut}, 1)

.from("[id*='img-2']", 1.5, {y: 350,ease:Power2.easeInOut}, 0.4)

.from("[id*='img-3-a']", 1.5, {y: 350,ease:Power2.easeInOut}, 0.6)
.from("[id*='img-3-b']", 1.5, {y: 350,ease:Power2.easeInOut}, 0.6)

.fromTo("[id*='img-3-b'] img", 8, {x: 100}, {x: -200, ease:Linear.easeNone}, 0.6)

//.to("[id*='img-']", 2.5, {x: 34, ease:Power2.easeInOut}, 0)
...
.from("[id*='logo']", 1, {ease:Power2.easeOut, autoAlpha:0}, 2.2)
.from("[id*='btn']", 1, {ease:Power2.easeOut, y: 150, autoAlpha: 0}, 2)


.to("[id*='img-3-a']", 1.5, {y: 350, ease:Power2.easeInOut}, 0)
.to("[id*='img-3-b']", 1.5, {y: 350, ease:Power2.easeInOut}, 0.2)

.to("[id*='img-2']", 1.5, {y: 350, ease:Power2.easeInOut}, 0.4)

.to("[id*='img-1-b'], [id*='img-1-a']", 1.5, {y: 350, ease:Power2.easeInOut}, 0.8)
.to("[id*='img-1-c']", 1.5, {y: 350, ease:Power2.easeInOut}, 0.6)
