...
.from("[id*='img-1-a']", 1.5, {y: 170,ease:Power2.easeInOut}, 0)
.from("[id*='img-1-c']", 1.5, {y: 170,ease:Power2.easeInOut}, 0.2)

.from("[id*='img-1-b']", 2, {autoAlpha: 0, ease:Power2.easeInOut}, 1)


/*

.from("[id*='img-2']", 1.5, {y: 200,ease:Power2.easeInOut}, 0.4)

.from("[id*='img-3-a']", 1.5, {y: 200,ease:Power2.easeInOut}, 0.6)
.from("[id*='img-3-b']", 1.5, {y: 200,ease:Power2.easeInOut}, 0.6)

.fromTo("[id*='img-3-b'] img", 8, {x: 200}, {x: 0, ease:Linear.easeNone}, 0.6)


*/
//.from("[id*='img-']", 2.5, {x: -48,ease:Power2.easeInOut}, 0)
...
.from("[id*='img-2']", 1.5, {y: 200,ease:Power2.easeInOut}, 0)
...
.from("[id*='img-3-a']", 1.5, {y: 200,ease:Power2.easeInOut}, 0)
.from("[id*='img-3-b']", 1.5, {y: 200,ease:Power2.easeInOut}, 0)

.fromTo("[id*='img-3-b'] img", 8, {x: 200}, {x: 0, ease:Linear.easeNone}, 0)
...
.from("[id*='txt-4']", 1, {ease:Power2.easeOut, autoAlpha:0, x: 20}, 1)
.from("[id*='logo']", 1, {ease:Power2.easeOut, autoAlpha:0}, 1.5)
.from("[id*='btn']", 1, {ease:Power2.easeOut, y: 150, autoAlpha: 0}, 1.7)

.to("[id*='txt-4']", 1, {ease:Power2.easeOut, autoAlpha:0}, 3.5)
.from("[id*='txt-5']", 1, {ease:Power2.easeOut, autoAlpha:0}, 4)


.to("[id*='img-3-a']", 1.5, {y: 200, autoAlpha: 0, ease:Power2.easeInOut}, 0.2)
.to("[id*='img-3-b']", 1.5, {y: 200, autoAlpha: 0, ease:Power2.easeInOut}, 0.2)

.to("[id*='img-2']", 1.5, {y: 200, autoAlpha: 0, ease:Power2.easeInOut}, 0.4)

.to("[id*='img-1-b'], [id*='img-1-a']", 1.5, {y: 200, autoAlpha: 0, ease:Power2.easeInOut}, 0.8)
.to("[id*='img-1-c']", 1.5, {y: 200, autoAlpha: 0, ease:Power2.easeInOut}, 0.6)
