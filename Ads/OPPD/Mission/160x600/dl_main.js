...
.from("[id*='img-1-a']", 2.3, {y: 450,ease:Power2.easeInOut}, 0)
.from("[id*='img-1-b']", 2.3, {y: 450,ease:Power2.easeInOut}, 0)

.from("[id*='img-2']", 2.3, {y: 450,ease:Power2.easeInOut}, 0.4)
.from("[id*='img-3-a']", 2.3, {y: 450,ease:Power2.easeInOut}, 0.6)
.from("[id*='img-3-b']", 2.3, {y: 450,ease:Power2.easeInOut}, 0.6)

.fromTo("[id*='img-3-b'] img", 10, {x: 100}, {x: -300, ease:Linear.easeNone}, 1.8)


//.to("#wrap-city", 6, {y: -100,ease:Power2.easeOut}, 0)
...
.fromTo("[id*='img-3-b'] img", 2, {x: 100}, {x: 0, ease:Linear.easeNone}, 1.8)


/*
.to("[id*='img-3']", 1.5, {y: 450, ease:Power2.easeInOut}, 0)
.to("[id*='img-2']", 1.5, {y: 450, ease:Power2.easeInOut}, 0.2)

.to("[id*='img-1-b']", 1.5, {y: 450, ease:Power2.easeInOut}, 0.6)
.to("[id*='img-1-a']", 1.5, {y: 450, ease:Power2.easeInOut}, 0.7)
