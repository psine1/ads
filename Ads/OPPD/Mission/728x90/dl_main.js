...
.from("[id*='img-1-a']", 1.5, {y: 200,ease:Power2.easeInOut}, 0.2)
.from("[id*='img-1-b']", 1.5, {y: 200,ease:Power2.easeInOut}, 0.2)

.from("[id*='img-2']", 1.5, {y: 100,ease:Power2.easeInOut}, 0.4)
.from("[id*='img-3-a']", 1.5, {y: 100,ease:Power2.easeInOut}, 0.6)
.from("[id*='img-3-b']", 1.5, {y: 100,ease:Power2.easeInOut}, 0.7)

.fromTo("[id*='img-3-b'] img", 8, {x: 150}, {x: 0, ease:Linear.easeNone}, 0.7)
...
.to("[id*='txt-3']", 1, {ease:Power2.easeOut, autoAlpha:0}, 2.5)
.from("[id*='txt-4']", 1, {ease:Power2.easeOut, autoAlpha:0, x: 20}, 2.7)
...
tl_.timeScale( 1 );  
tl_
.to("[id*='txt-4']", 1, {ease:Power2.easeOut, autoAlpha:0}, 0.5)

.from("[id*='txt-5']", 1, {ease:Power2.easeOut, autoAlpha:0}, 1)
