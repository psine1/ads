...
.from("[id*='img-1-a']", 2, {y: 350,ease:Power2.easeInOut}, 0.2)
.from("[id*='img-1-b']", 2, {y: 350,ease:Power2.easeInOut}, 0.2)

.from("[id*='img-2']", 2, {y: 350,ease:Power2.easeInOut}, 0.4)
.from("[id*='img-3-a']", 2, {y: 350,ease:Power2.easeInOut}, 0.6)
.from("[id*='img-3-b']", 2, {y: 350,ease:Power2.easeInOut}, 0.6)
...
.to("[id*='img-3']", 1.5, {y: 350, ease:Power2.easeInOut}, 0)
.to("[id*='img-2']", 1.5, {y: 350, ease:Power2.easeInOut}, 0.2)

.to("[id*='img-1-b']", 1.5, {y: 350, ease:Power2.easeInOut}, 0.6)
.to("[id*='img-1-a']", 1.5, {y: 350, ease:Power2.easeInOut}, 0.6)
