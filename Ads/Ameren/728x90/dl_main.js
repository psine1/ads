...
function fr1(){
    ...
    tl_fr1
        .to("[id*='txt-1']", {duration: 1, autoAlpha: 0, ease: "power3.out"}, 0)    
        .to("[id*='prod-1']", {duration: 1, x: -385, scale: 1, ease: "power3.out"}, 0.5)    
    ...
    tl_correct
        ...
        .to("#prod-1", {duration: 0.7, autoAlpha: 1, ease: "power3.out"}, 0.5)        
       ...
       // .to("#prod-1", {duration: 0.7, autoAlpha: 1, scale: 0.85, y: -100, x: 100, ease: "power3.out"}, 2.5)        
        .from("#prod-2", {duration: 1, autoAlpha: 0, x: 20, ease: "power3.out"}, 3)
        .from("#prod-3", {duration: 1, autoAlpha: 0, x: -20, ease: "power3.out"}, 3)
  ...
  .set("[id*='prod-']", {zIndex: 999999})
        .to("[id*='prod-1']", {duration: 1, x: -375, scale: 1, ease: "power3.out"}, 3.5)    
