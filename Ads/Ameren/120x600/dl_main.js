...
function fr1(){
    ...
    tl_correct
        ...
        .to("#btn-1, #btn-2, #btn-3, #btn-4", {duration: 0.7, autoAlpha: 0, ease: "power3.out"}, 0.7)
        .from("#correct", {duration: 0.7, autoAlpha: 0, scale: 1.2, ease: "power3.out"}, 1)
        ...
        .from("#prod-2", {duration: 1, autoAlpha: 0, x: 50, ease: "power3.out"}, 3)
        .from("#prod-3", {duration: 1, autoAlpha: 0, x: -50, ease: "power3.out"}, 3)
...
function hover(elem, color){
      ...
      tl_hover
      .to(elem, {duration: 0.5, backgroundColor: color, scale: 1.01, rotation: 0.1, ease: "power3.out"}, 0)
return tl_hover;
}
