...
myBanner.main = function() {
	...
	myBanner.preloadImages(images, function() {
		...
		//	frame_1_shine2.classList.add('frame_1_shine1');
			...
			var txt_1 = myBanner.createElement({backgroundImage: "txt_1.png", left: 204/2, top: 68/2, retina: true, parent: banner});
		...
		var frame_2 = myBanner.createElement({width: 728, height: 90, parent: banner});
			...
			var txt_2 = myBanner.createElement({backgroundImage: "txt_2.png", left: 199/2, top:69/2, retina: true, parent: frame_2});
		var endframe = myBanner.createElement({width: 728, height: 90, parent: banner});
			...
			var txt_4 = myBanner.createElement({backgroundImage: "txt_4.png", left: 463/2, top: 101/2, retina: true, parent: endframe});
			var txt_3 = myBanner.createElement({backgroundImage: "txt_3.png", left: 463/2, top: 54/2, retina: true, parent: endframe});
		...
		var frame_1_overlay = myBanner.createElement({backgroundColor: "#00ff00", left: 586, top: 0, width: 45, height: 200, parent: banner});
		var frame_1_b_overlay = myBanner.createElement({backgroundColor: "#00ff00", left: 586, top: 230, width: 45, height: 20, parent: banner});

		var frame_2_overlay = myBanner.createElement({backgroundColor: "#00ff00", left: 588, top: 75, width: 47, height: 5, parent: banner});
		var frame_2_b_overlay = myBanner.createElement({backgroundColor: "#00ff00", left: 588, top: 75, width: 47, height: 5, parent: banner});

		var frame_3_overlay = myBanner.createElement({backgroundColor: "#ffcc00", left: 163, top: 0, width: 45, height: 90, parent: banner});
		...
		var shine_container = myBanner.createElement({left: 1152/2, top: 76/2, width: 139/2, height: 91/2, parent: banner});
			...
			var endframe_shine = myBanner.createElement({backgroundImage: "", top: 728, left: 28, parent: shine_container});
		...
		function init() {
			...
			.fromTo(shineMaskPos_2, 3, {x: -150}, {x: shine_2.get("width")*3, ease: Power1.easeOut});
