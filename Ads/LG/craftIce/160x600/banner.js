...
myBanner.main = function() {
	...
	myBanner.preloadImages(images, function() {
		...
		var frame_1 = myBanner.createElement({width: 160, height: 600, parent: banner});
			...
			var txt_1 = myBanner.createElement({backgroundImage: "txt_1.png", left: 48/2, top: 813/2, retina: true, parent: banner});
		...
		var frame_2 = myBanner.createElement({width: 160, height: 600, parent: banner});
			...
			var txt_2 = myBanner.createElement({backgroundImage: "txt_2.png", left: 50/2, top:765/2, retina: true, parent: frame_2});
		var endframe = myBanner.createElement({width: 160, height: 600, parent: banner});
			...
			var txt_4 = myBanner.createElement({backgroundImage: "txt_4.png", left: 49/2, top: 807/2, retina: true, parent: endframe});
			var txt_3 = myBanner.createElement({backgroundImage: "txt_3.png", left: 49/2, top: 715/2, retina: true, parent: endframe});
		...
		var frame_2_overlay = myBanner.createElement({backgroundColor: "#00ff00", left: 10, top: 250, width: 5, height: 63, parent: banner});
		var frame_2_b_overlay = myBanner.createElement({backgroundColor: "#00ff00", left: 10, top: 250, width: 5, height: 63, parent: banner});
