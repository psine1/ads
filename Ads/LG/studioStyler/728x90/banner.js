...
myBanner.main = function() {
	...
	myBanner.preloadImages(images, function() {
		...
		var endframe = myBanner.createElement({width: 728, height: 90, parent: banner});
			...
			var txt_3 = myBanner.createElement({backgroundImage: "txt_3.png", left: 362, top: 30, retina: true, parent: endframe, rotation: 0.1, force3D: true});
			var txt_4 = myBanner.createElement({backgroundImage: "txt_4.png", left: 362, top: 52, retina: true, parent: endframe, rotation: 0.1, force3D: true});
		
		
		var frame_1_overlay = myBanner.createElement({backgroundColor: "#00ff00", left: 528, width: 34, height: 90, parent: banner});
		var frame_2_overlay = myBanner.createElement({backgroundColor: "#00ff00", left: 524, width: 42, height: 90, parent: banner});
		var frame_3_overlay = myBanner.createElement({backgroundColor: "#00ff00", left: 192, width: 27, height: 90, parent: banner});

		

		var shine_container = myBanner.createElement({left: 528, width: 393, height: 89, parent: banner});
			...
			var frame_1_shine = myBanner.createElement({backgroundImage: "frame_1_shine.png", left: -1, top: 1, retina: true, parent: shine_container});

			var frame_2_shine = myBanner.createElement({backgroundImage: "frame_2_shine.png", left: -5, top: 0, retina: true, parent: shine_container});
		...
		var steam = myBanner.createElement({width: 300, height: 200, top: 30, left: 470, parent: banner});
		...
		function init() {
			...
			.to(shine_container, 0.01, {x: -336, ease: Power1.easeOut})			
