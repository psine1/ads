...
myBanner.main = function() {
	...
	myBanner.preloadImages(images, function() {
		...
		var frame_1 = myBanner.createElement({width: 300, height: 600, parent: banner});
			...
			var txt_1 = myBanner.createElement({backgroundImage: "txt_1.png", left: 233/2, top: 970/2, retina: true, parent: banner});
		...
		var frame_2 = myBanner.createElement({width: 300, height: 600, parent: banner});
			...
			var txt_2 = myBanner.createElement({backgroundImage: "txt_2.png", left: 230/2, top:932/2, retina: true, parent: frame_2});
		...
		var endframe = myBanner.createElement({width: 300, height: 600, parent: banner});
			...
			var txt_4 = myBanner.createElement({backgroundImage: "txt_4.png", left: 68/2, top: 937/2, retina: true, parent: endframe});
			var txt_3 = myBanner.createElement({backgroundImage: "txt_3.png", left: 68/2, top: 822/2, retina: true, parent: endframe});
		...
		var frame_1_overlay = myBanner.createElement({backgroundColor: "#00ff00", left: 280, top: 47, width: 123, height: 0, parent: banner});
		var frame_1_b_overlay = myBanner.createElement({backgroundColor: "#00ff00", left: 153, top: 230, width: 123, height: 0, parent: banner});

		var frame_2_overlay = myBanner.createElement({backgroundColor: "#00ff00", left: 0, top: 62, width: 30, height: 86, parent: banner});
		var frame_2_b_overlay = myBanner.createElement({backgroundColor: "#00ff00", left: 0, top: 62, width: 30, height: 86, parent: banner});

		var frame_3_overlay = myBanner.createElement({backgroundColor: "#ffcc00", left: 280, top: 63, width: 123, height: 0, parent: banner});
		...
		var shine_container = myBanner.createElement({left: 0, top: 0, width: 300, height: 600, parent: banner});
			var frame_1_shine = myBanner.createElement({backgroundImage: "frame_1_shine.png", left: 137/2, top: 514/2,  parent: shine_container});
			...
			var endframe_shine = myBanner.createElement({backgroundImage: "endframe_shine.png", left: 133/2, top: 297/2, parent: shine_container});
