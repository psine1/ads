...
myBanner.main = function() {
	...
	myBanner.preloadImages(images, function() {
		...
		var frame_1 = myBanner.createElement({width: 160, height: 600, parent: banner});
			...
			var txt_1 = myBanner.createElement({backgroundImage: "txt_1.png", left: 50/2, top: 875/2, retina: true, parent: banner});
		...
		var frame_2 = myBanner.createElement({width: 160, height: 600, parent: banner});
			...
			var txt_2 = myBanner.createElement({backgroundImage: "txt_2.png", left: 48/2, top: 820/2, retina: true, parent: frame_2});
		var endframe = myBanner.createElement({width: 160, height: 600, parent: banner});
			...
			var txt_4 = myBanner.createElement({backgroundImage: "txt_4.png", left: 47/2, top: 804/2, retina: true, parent: endframe});
			var txt_3 = myBanner.createElement({backgroundImage: "txt_3.png", left: 47/2, top: 725/2, retina: true, parent: endframe});
		...
		var frame_1_overlay = myBanner.createElement({backgroundColor: "#00ff00", left: 120, top: 85, width: 123, height: 0, parent: banner});
		var frame_1_b_overlay = myBanner.createElement({backgroundColor: "#00ff00", left: 153, top: 230, width: 123, height: 0, parent: banner});

		var frame_2_overlay = myBanner.createElement({backgroundColor: "#00ff00", left: 10, top: 50, width: 160, height: 130, parent: banner});
		var frame_2_b_overlay = myBanner.createElement({backgroundColor: "#00ff00", left: 10, top: 50, width: 160, height: 130, parent: banner});
		...
		var shine_container = myBanner.createElement({left: 0, top: 0, width: 160, height: 600, parent: banner});
			var frame_1_shine = myBanner.createElement({backgroundImage: "frame_1_shine.png", left: 47/2, top: 510/2,  parent: shine_container});
			...
			var endframe_shine = myBanner.createElement({backgroundImage: "endframe_shine.png", top: 374/2, left: 64/2, parent: shine_container});
