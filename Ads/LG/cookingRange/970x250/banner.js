...
myBanner.main = function() {
	...
	myBanner.preloadImages(images, function() {
		...
		var frame_1_overlay = myBanner.createElement({backgroundColor: "#00ff00", left: 963/2, top: 9, width: 372/2, height: 250, parent: banner});
		var frame_1_b_overlay = myBanner.createElement({backgroundColor: "#00ff00", left: 963/2, top: 9, width: 372/2, height: 250, parent: banner});

		var frame_2_overlay = myBanner.createElement({backgroundColor: "#00ff00", left: 900/2, top: 9, width: 2000/2, height: 250, parent: banner});
		var frame_2_b_overlay = myBanner.createElement({backgroundColor: "#00ff00", left: 900/2, top: 9, width: 2000/2, height: 250, parent: banner});

		var frame_3_overlay = myBanner.createElement({backgroundColor: "#ffcc00", left: 248, top: 0, width: 0, height: 0, parent: banner});
		...
		var shine_container = myBanner.createElement({left: 0, top: 0, width: 970, height: 250, parent: banner});
			var frame_1_shine = myBanner.createElement({backgroundImage: "frame_1_shine.png", left: 967/2, top: 134/2,  parent: shine_container});
			var frame_2_shine = myBanner.createElement({backgroundImage: "frame_2_shine.png", left: 0, top: 0, parent: shine_container});

			var endframe_shine = myBanner.createElement({backgroundImage: "endframe_shine.png", top: 56/2, left: 440/2, parent: shine_container});
