...
myBanner.main = function() {
	...
	myBanner.preloadImages(images, function() {
		...
		var frame_1_overlay = myBanner.createElement({backgroundColor: "#00ff00", left: 271, top: 35, width: 25, height: 169, parent: banner});
		var frame_2_overlay = myBanner.createElement({backgroundColor: "#00ff00", left: 280, top: 37, width: 82, height: 122, parent: banner});
		var frame_2_b_overlay = myBanner.createElement({backgroundColor: "#00ff00", left: 141, top: 0, width: 82, height: 25, parent: banner});

		var frame_3_overlay = myBanner.createElement({backgroundColor: "#ffcc00", left: 180, top: 0, width: 0, height: 25, parent: banner});
		...
		var shine_container = myBanner.createElement({left: 150, top: 0, width: 150, height: 250, parent: banner});
			var frame_1_shine = myBanner.createElement({backgroundImage: "frame_1_shine.png", left: 80, top: 35, parent: shine_container});
			var frame_2_shine = myBanner.createElement({backgroundImage: "frame_2_shine.png", left: -13, top: 6, parent: shine_container});
			var endframe_shine = myBanner.createElement({backgroundImage: "endframe_shine.png", top: 28, left: 37, parent: shine_container});
		...
		TweenMax.set([logo_lg_1_container, logo_lg_2_container, frame_1_overlay, frame_2_overlay, frame_3_overlay, frame_2_b_overlay, shine_container], {overflow: "hidden", zIndex: 20})
