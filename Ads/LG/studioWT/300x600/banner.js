...
myBanner.main = function() {
	...
	myBanner.preloadImages(images, function() {
		...
		var frame_2 = myBanner.createElement({width: 300, height: 600, parent: banner});
			...
			var txt_2 = myBanner.createElement({backgroundImage: "txt_2.png", left: 130, top: 510, retina: true, parent: frame_2, rotation: 0.1, force3D: true});
		...
		var frame_1_overlay = myBanner.createElement({backgroundColor: "#00ff00", left: 271, top: 50, width: 25, height: 375, parent: banner});
		var frame_2_overlay = myBanner.createElement({left: 0, top: 0, width: 300, height: 250, parent: banner});
		...
		var frame_2_overlay_img = myBanner.createElement({
		...
		TweenMax.set([logo_lg_1, logo_lg_2, shine_container, frame_1_overlay, frame_2_overlay], {overflow: "hidden", zIndex: 10})
