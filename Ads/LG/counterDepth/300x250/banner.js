...
myBanner.main = function() {
	...
	myBanner.preloadImages(images, function() {
		...
		var frame_1 = myBanner.createElement({width: 300, height: 250, parent: banner});
			...
			var frame_1_shine1 = myBanner.createElement({backgroundImage: "frame_1_shine.png", left: 112, top: 91, width: 180, height: 99, parent: banner});
			frame_1_shine1.classList.add('frame_1_shine1');


			var frame_1_shine2 = myBanner.createElement({backgroundImage: "frame_1_shine.png", left: 112, top: 91, width: 180, height: 99, parent: banner});
			frame_1_shine2.classList.add('frame_1_shine1');

			var frame_1_shine3 = myBanner.createElement({backgroundImage: "frame_1_shine.png", left: 112, top: 91, width: 180, height: 99, parent: banner});
			frame_1_shine3.classList.add('frame_1_shine1');

			var txt_1 = myBanner.createElement({backgroundImage: "txt_1.png", left: 35, top: 80, retina: true, parent: banner});
			...
			var txt_2 = myBanner.createElement({zIndex:200,backgroundImage: "txt_2.png", left: 35, top:54, retina: true, parent: banner});
			// console.log(txt_2)
		...
		var endframe = myBanner.createElement({width: 300, height: 250, parent: banner});
			...
			var txt_3 = myBanner.createElement({backgroundImage: "txt_3.png", left: 26, top: 161, retina: true, parent: endframe});
		...
		var frame_1_overlay = myBanner.createElement({backgroundColor: "#00ff00", left: 153, top: 0, width: 123, height: 200, parent: banner});
		var frame_1_b_overlay = myBanner.createElement({backgroundColor: "#00ff00", left: 153, top: 230, width: 123, height: 20, parent: banner});

		var frame_2_overlay = myBanner.createElement({backgroundColor: "#00ff00", left: 120, top: 230, width: 0, height: 0, parent: banner});
		var frame_2_b_overlay = myBanner.createElement({backgroundColor: "#00ff00", left: 121, top: 9, width: 180, height: 120, parent: banner});

		var frame_3_overlay = myBanner.createElement({backgroundColor: "#ffcc00", left: 163, top: 0, width: 102, height: 25, parent: banner});
		...
		var shine_container = myBanner.createElement({left: 141, top: 0, width: 150, height: 250, parent: banner});
			var frame_1_shine = myBanner.createElement({backgroundImage: "", left: 3, top: 154,  parent: shine_container});
			// var frame_2_shine = myBanner.createElement({backgroundImage: "frame_2_shine.png", left: 0, top: 153, parent: shine_container});
		...
		var frame_1_b_overlay_img = myBanner.createElement({ width: 300, height: 250,
		...
		var frame_2_b_overlay_img = myBanner.createElement({width: 300, height: 250,
