...
myBanner.main = function() {
	...
	myBanner.preloadImages(images, function() {
		...
		var frame_1 = myBanner.createElement({width: 160, height: 600, parent: banner});
			var frame_1_bg = myBanner.createElement({backgroundImage: "frame_1_bg.jpg", retina: true, parent: frame_1});

			var frame_1_shine1 = myBanner.createElement({backgroundImage: "frame_1_shine.png", left: -10, top: 223, width: 393, height: 66, parent: banner});
			frame_1_shine1.classList.add('frame_1_shine1');


			var frame_1_shine2 = myBanner.createElement({backgroundImage: "frame_1_shine.png", left: -12/2, top: 479/2, width: 258/2, height: 171/2, parent: banner});
			frame_1_shine2.classList.add('frame_1_shine1');

			var frame_1_shine3 = myBanner.createElement({backgroundImage: "frame_1_shine.png", left: -10, top: 230, width: 180, height: 99, parent: banner});
			frame_1_shine3.classList.add('frame_1_shine1');

			var txt_1 = myBanner.createElement({backgroundImage: "txt_1.png", left: 51/2, top: 894/2, retina: true, parent: banner});
			txt_1.style.zIndex = '9999';
		var frame_2 = myBanner.createElement({width: 160, height: 600, parent: banner});
			var frame_2_bg = myBanner.createElement({backgroundImage: "frame_2_bg.jpg", retina: true, parent: frame_2});

			var txt_2 = myBanner.createElement({backgroundImage: "txt_2.png", left: 50/2, top: 854/2, retina: true, parent: frame_2});
		var endframe = myBanner.createElement({width: 160, height: 600, parent: banner});
			var endframe_bg = myBanner.createElement({backgroundImage: "endframe_bg.jpg", retina: true, parent: endframe});
			var txt_4 = myBanner.createElement({backgroundImage: "txt_4.png", left: 47/2, top: 806/2, retina: true, parent: endframe});
			var txt_3 = myBanner.createElement({backgroundImage: "txt_3.png", left: 46/2, top: 725/2, retina: true, parent: endframe});
			var cta = myBanner.createElement({left: 49/2, top: 1024/2, width: 220/2, height: 24/2, parent: endframe});
		...
		var frame_1_overlay = myBanner.createElement({backgroundColor: "#00ff00", left: 120, top: 85, width: 123, height: 277, parent: banner});
		var frame_1_b_overlay = myBanner.createElement({backgroundColor: "#00ff00", left: 153, top: 230, width: 123, height: 20, parent: banner});

		var frame_2_overlay = myBanner.createElement({backgroundColor: "#00ff00", left: 10, top: 222/2, width: 160, height: 293/2, parent: banner});
		var frame_2_b_overlay = myBanner.createElement({backgroundColor: "#00ff00", left: 10, top: 222/2, width: 160, height: 293/2, parent: banner});

		var frame_3_overlay = myBanner.createElement({backgroundColor: "#ffcc00", left: 280, top: 63, width: 123, height: 323, parent: banner});

		var logo_lg_2_container = myBanner.createElement({top: 34, width: 99, height: 87, parent: banner});
		...
		var logo_lg_1_container = myBanner.createElement({top: 994/2, left: 0, width: 180/2, height: 135/2, parent: banner});
			var logo_lg_1_base = myBanner.createElement({backgroundColor: "#f7f6f7", width: 180/2, height: 135/2, parent: logo_lg_1_container, rotation: 0.1, force3D: true});
			var logo_lg_1 = myBanner.createElement({backgroundImage: "logo_lg_1.png", left: 25, top: 11, retina: true, parent: logo_lg_1_container, rotation: 0.1, force3D: true});

		var shine_container = myBanner.createElement({left: 141, top: 0, width: 150, height: 600, parent: banner});
			var frame_1_shine = myBanner.createElement({backgroundImage: "", left: 3, top: 154,  parent: shine_container});

			var frame_2_shine = myBanner.createElement({backgroundImage: "frame_2_shine.png", left: -13/2, top: 479/2, width: 258/2, height: 171/2, zIndex: 99999, parent: banner});

			var endframe_shine = myBanner.createElement({backgroundImage: "", top: 100, left: 28, parent: shine_container});
		...
		var frame_1_overlay_img = myBanner.createElement({ width: 160, height: 600,
		...
		var frame_1_b_overlay_img = myBanner.createElement({ width: 160, height: 600,
			left: -frame_1_b_overlay.get("left"), top: -frame_1_b_overlay.get("top"), backgroundImage: "frame_1_bg.jpg", retina: true, 
			parent: frame_1_b_overlay})
		

		var frame_2_overlay_img = myBanner.createElement({ width: 160, height: 600,
		...
		var frame_2_b_overlay_img = myBanner.createElement({ width: 160, height: 600,
		...
		var frame_3_overlay_img = myBanner.createElement({width: 160, height: 600,
		...
		var shineImage_1 = new Image(); shineImage_1.src = "";
		var shineMaskPos_1 = {x: 0, y: 0};
	
		TweenMax.set(frame_1_shine, {visibility: "hidden"});	// hide shine image

		/* shine element 2 */
		var shine_2 = myBanner.createElement({type: "canvas", left: frame_2_shine.get("left"), top: frame_2_shine.get("top"), width: frame_2_shine.get("width"), height: frame_2_shine.get("height"), parent: banner});
		...
		var shineImage_3 = new Image(); shineImage_3.src = "";
		...
		function init() {
			...
			shine_1_fnc = function() {
				...
				.to(frame_1_shine1, 0.3, { alpha:1,  ease: Power0.linear})
				.fromTo(frame_1_shine1, 1.2, {x:0, ease: Power0.linear}, {x:150, ease: Power0.linear},"-=.2")
				.to(frame_1_shine1, 0.4, { alpha:0, ease: Power0.linear},"-=.4")
			}

			shine_3_fnc = function() {
				return new TimelineMax()

				.to(frame_1_shine3, 0.3, { alpha:1,  ease: Power0.linear})
				.fromTo(frame_1_shine3, 1.2, {x:10,y:-27, ease: Power0.linear}, {x:87,y:-23, ease: Power0.linear},"-=.2")
				.to(frame_1_shine3, 0.4, { alpha:0, ease: Power0.linear},"-=.4")
			}
