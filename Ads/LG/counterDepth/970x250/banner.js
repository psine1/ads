...
myBanner.main = function() {
	...
	myBanner.preloadImages(images, function() {
		...
		var frame_1 = myBanner.createElement({width: 970, height: 250, parent: banner});
			...
			var frame_1_shine1 = myBanner.createElement({backgroundImage: "frame_1_shine.png", left: 580, top: 95, width: 180, height: 99, parent: banner});
			frame_1_shine1.classList.add('frame_1_shine1');


			var frame_1_shine2 = myBanner.createElement({backgroundImage: "frame_1_shine.png", left: -5000/2, top: 313/2, width: 268/2, height: 176/2, parent: banner});
		//	frame_1_shine2.classList.add('frame_1_shine1');

			var frame_1_shine3 = myBanner.createElement({backgroundImage: "frame_1_shine.png", left: 210, top: 115, width: 180, height: 99, parent: banner});
			frame_1_shine3.classList.add('frame_1_shine1');

			var txt_1 = myBanner.createElement({backgroundImage: "txt_1.png", left: 353/2, top: 241/2, retina: true, parent: banner});
		...
		var frame_2 = myBanner.createElement({width: 970, height: 250, parent: banner});
			...
			var txt_2 = myBanner.createElement({backgroundImage: "txt_2.png", left: 356/2, top: 191/2, retina: true, parent: frame_2});
		var endframe = myBanner.createElement({width: 970, height: 250, parent: banner});
			...
			var txt_4 = myBanner.createElement({backgroundImage: "txt_4.png", left: 830/2, top: 235/2, retina: true, parent: endframe});
			var txt_3 = myBanner.createElement({backgroundImage: "txt_3.png", left: 832/2, top: 157/2, retina: true, parent: endframe});

			var cta = myBanner.createElement({left: 830/2, top: 341/2, width: 285/2, height: 32/2, parent: endframe});
		...
		var frame_1_overlay = myBanner.createElement({backgroundColor: "#00ff00", left: 603, top: 0, width: 130, height: 200, parent: banner});
		var frame_1_b_overlay = myBanner.createElement({backgroundColor: "#00ff00", left: 603, top: 230, width: 130, height: 20, parent: banner});

		var frame_2_overlay = myBanner.createElement({backgroundColor: "#00ff00", left: 1120/2, top: 9, width: 430/2, height: 250, parent: banner});
		var frame_2_b_overlay = myBanner.createElement({backgroundColor: "#00ff00", left: 1120/2, top: 9, width: 430/2, height: 250, parent: banner});

		var frame_3_overlay = myBanner.createElement({backgroundColor: "#ffcc00", left: 248, top: 0, width: 118, height: 250, parent: banner});

		var logo_lg_2_container = myBanner.createElement({top: 75/2, width: 317/2, height: 267/2, parent: banner});
			var logo_lg_2_base = myBanner.createElement({backgroundColor: "#f7f6f7", width: 317/2, height: 267/2, parent: logo_lg_2_container, rotation: 0.1, force3D: true});
			var logo_lg_2 = myBanner.createElement({backgroundImage: "logo_lg_2.png", left: 96/2, top: 30/2, retina: true, parent: logo_lg_2_container, rotation: 0.1, force3D: true});

		var logo_lg_1_container = myBanner.createElement({top: 223/2, width: 317/2, height: 176/2, parent: banner});
			var logo_lg_1_base = myBanner.createElement({backgroundColor: "#f7f6f7", width: 317/2, height: 176/2, parent: logo_lg_1_container, rotation: 0.1, force3D: true});
			var logo_lg_1 = myBanner.createElement({backgroundImage: "logo_lg_1.png", left: 137/2, top: 22/2, retina: true, parent: logo_lg_1_container, rotation: 0.1, force3D: true});

		var shine_container = myBanner.createElement({left: 1188/2, top: 313/2, width: 268/2, height: 176/2, parent: banner});
			...
			var endframe_shine = myBanner.createElement({backgroundImage: "", top: 970, left: 28, parent: shine_container});
		...
		var frame_1_overlay_img = myBanner.createElement({ width: 970, height: 250,
		...
		var frame_1_b_overlay_img = myBanner.createElement({ width: 970, height: 250,
		...
		var frame_2_overlay_img = myBanner.createElement({ width: 970, height: 250,
		...
		var frame_2_b_overlay_img = myBanner.createElement({width: 970, height: 250,
		...
		var frame_3_overlay_img = myBanner.createElement({width: 970, height: 250,
		...
		function init() {
			...
			shine_1_fnc = function() {
				...
				.fromTo(frame_1_shine1, 1.2, {x:0, ease: Power0.linear}, {x:100, ease: Power0.linear},"-=.2")
