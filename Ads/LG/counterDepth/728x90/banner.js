...
myBanner.main = function() {
	...
	myBanner.preloadImages(images, function() {
		...
		//	frame_1_shine2.classList.add('frame_1_shine1');
			...
			var txt_1 = myBanner.createElement({backgroundImage: "txt_1.png", left: 207/2, top: 68/2, retina: true, parent: banner});
		...
		var frame_2 = myBanner.createElement({width: 728, height: 90, parent: banner});
			...
			var txt_2 = myBanner.createElement({backgroundImage: "txt_2.png", left: 201/2, top:69/2, retina: true, parent: frame_2});
		...
		var frame_2_overlay = myBanner.createElement({backgroundColor: "#00ff00", left: 1117/2, top: 0, width: 196/2, height: 90, parent: banner});
		var frame_2_b_overlay = myBanner.createElement({backgroundColor: "#00ff00", left: 1117/2, top: 0, width: 196/2, height: 90, parent: banner});
		...
		var shine_container = myBanner.createElement({left: 1152/2, top: 76/2, width: 139/2, height: 91/2, parent: banner});
			var frame_1_shine = myBanner.createElement({backgroundImage: "frame_1_shine.png", left: 3, top: 154,  parent: shine_container});
