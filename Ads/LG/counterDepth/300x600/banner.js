...
myBanner.main = function() {
	...
	myBanner.preloadImages(images, function() {
		...
		var frame_1 = myBanner.createElement({width: 300, height: 600, parent: banner});
			...
			var frame_1_shine1 = myBanner.createElement({backgroundImage: "frame_1_shine.png", left: 105, top: 245, width: 393, height: 66, parent: banner});
			frame_1_shine1.classList.add('frame_1_shine1');


			var frame_1_shine2 = myBanner.createElement({backgroundImage: "frame_1_shine.png", left: 112, top: 91, width: 180, height: 30, parent: banner});
			...
			var txt_1 = myBanner.createElement({backgroundImage: "txt_1.png", left: 231/2, top: 976/2, retina: true, parent: banner});
		...
		var frame_2 = myBanner.createElement({width: 300, height: 600, parent: banner});
			...
			var txt_2 = myBanner.createElement({backgroundImage: "txt_2.png", left: 229/2, top:950/2, retina: true, parent: frame_2});
		...
		var endframe = myBanner.createElement({width: 300, height: 600, parent: banner});
			...
			var txt_4 = myBanner.createElement({backgroundImage: "txt_4.png", left: 66/2, top: 939/2, retina: true, parent: endframe});
			var txt_3 = myBanner.createElement({backgroundImage: "txt_3.png", left: 67/2, top: 822/2, retina: true, parent: endframe});
			var cta = myBanner.createElement({left: 71/2, top: 1078/2, width: 281/2, height: 31/2, parent: endframe});
		...
		var frame_1_overlay = myBanner.createElement({backgroundColor: "#00ff00", left: 280, top: 47, width: 123, height: 369, parent: banner});
		var frame_1_b_overlay = myBanner.createElement({backgroundColor: "#00ff00", left: 153, top: 230, width: 123, height: 20, parent: banner});

		var frame_2_overlay = myBanner.createElement({backgroundColor: "#00ff00", left: 0, top: 53, width: 300, height: 210, parent: banner});
		var frame_2_b_overlay = myBanner.createElement({backgroundColor: "#00ff00", left: 0, top: 53, width: 300, height: 210, parent: banner});
		...
		var logo_lg_1_container = myBanner.createElement({top: 478, width: 102, height: 66, parent: banner});
			var logo_lg_1_base = myBanner.createElement({backgroundColor: "#f7f6f7", width: 102, height: 67, parent: logo_lg_1_container, rotation: 0.1, force3D: true});
			var logo_lg_1 = myBanner.createElement({backgroundImage: "logo_lg_1.png", left: 36, top: 10, retina: true, parent: logo_lg_1_container, rotation: 0.1, force3D: true});
		...
		var shine_container = myBanner.createElement({left: 141, top: 0, width: 150, height: 600, parent: banner});
			...
			var frame_2_shine = myBanner.createElement({backgroundImage: "frame_2_shine.png", left: 92/2, top: 521/2, width: 359/2, height: 238/2, parent: banner});
		...
		var frame_1_overlay_img = myBanner.createElement({ width: 300, height: 600,
		...
		var frame_1_b_overlay_img = myBanner.createElement({ width: 300, height: 600,
		...
		var frame_2_overlay_img = myBanner.createElement({ width: 300, height: 600,
		...
		var frame_2_b_overlay_img = myBanner.createElement({width: 300, height: 600,
		...
		var frame_3_overlay_img = myBanner.createElement({width: 300, height: 600,
